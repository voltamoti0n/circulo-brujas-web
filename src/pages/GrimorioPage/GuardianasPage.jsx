// src/pages/GrimorioPage/GuardianasPage.jsx
import React, { useState, useRef, useEffect, useCallback } from 'react';
import { gsap } from 'gsap';
import styles from './GuardianasPage.module.css';
import useParallaxBackground from '../../hooks/useParallaxBackground';
import ArrowButton from '../../components/ArrowButton/ArrowButton';

// Datos de las imágenes para el carrusel de Guardianas
const guardianasImages = [
  { id: 1, src: '/assets/images/guardianas/guardianas_1.jpg', alt: 'Imagen Guardiana 1' },
  { id: 2, src: '/assets/images/guardianas/guardianas_2.jpg', alt: 'Imagen Guardiana 2' },
  { id: 3, src: '/assets/images/guardianas/guardianas_3.jpg', alt: 'Imagen Guardiana 3' },
  { id: 4, src: '/assets/images/guardianas/guardianas_4.jpg', alt: 'Imagen Guardiana 4' },
  { id: 5, src: '/assets/images/guardianas/guardianas_5.jpg', alt: 'Imagen Guardiana 5' },
  { id: 6, src: '/assets/images/guardianas/guardianas_6.jpg', alt: 'Imagen Guardiana 6' },
];

const GuardianasPage = () => {
  ...
  const numImages = guardianasImages.length;
  ...
  return (
    <div ref={pageRef} className={styles.pageContainer}>
        <div className={styles.textBlock}>
          <h1>Guardianas.</h1>
          <p>
            <strong>Protegen lo olvidado. Narran lo urgente. Su cine es denuncia, es resistencia.</strong> Directoras que abordan temas sociales, políticos, ambientales o históricos.
          </p>
        </div>
        ...
        <div className={styles.carouselSection}>
          <div className={styles.carouselWrapper}>
            <div className={styles.carousel}>
              {guardianasImages.map((image, index) => (
                <div
                  key={image.id}
