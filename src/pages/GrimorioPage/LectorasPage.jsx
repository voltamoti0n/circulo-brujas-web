// src/pages/GrimorioPage/LectorasPage.jsx
import React, { useState, useRef, useEffect, useCallback } from 'react';
import { gsap } from 'gsap';
import styles from './LectorasPage.module.css';
import useParallaxBackground from '../../hooks/useParallaxBackground';
import ArrowButton from '../../components/ArrowButton/ArrowButton';

// Datos de las imágenes para el carrusel de Lectoras
const lectorasImages = [
  { id: 1, src: '/assets/images/lectoras/lectoras_1.jpg', alt: 'Imagen Lectora 1' },
  { id: 2, src: '/assets/images/lectoras/lectoras_2.jpg', alt: 'Imagen Lectora 2' },
  { id: 3, src: '/assets/images/lectoras/lectoras_3.jpg', alt: 'Imagen Lectora 3' },
  { id: 4, src: '/assets/images/lectoras/lectoras_4.jpg', alt: 'Imagen Lectora 4' },
  { id: 5, src: '/assets/images/lectoras/lectoras_5.jpg', alt: 'Imagen Lectora 5' },
];
...
const LectorasPage = () => {
  ...
  const numImages = lectorasImages.length;
  ...
  return (
    <div ref={pageRef} className={styles.pageContainer}>
        <div className={styles.textBlock}>
          <h1>Lectoras.</h1>
          <p>
            <strong>Domadoras del lenguaje audiovisual. Narradoras que piensan cada plano como palabra.</strong> Directoras con dominio técnico y narrativo sobresaliente que se destacan por cómo cuentan sus historias tanto en estructura como en estilo visual.
          </p>
        </div>
        ...
        <div className={styles.carouselSection}>
          <div className={styles.carouselWrapper}>
            <div className={styles.carousel}>
              {lectorasImages.map((image, index) => (
                <div
                  key={image.id}
